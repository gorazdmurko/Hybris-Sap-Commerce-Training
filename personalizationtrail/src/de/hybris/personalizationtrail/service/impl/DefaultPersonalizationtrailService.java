...
public class DefaultPersonalizationtrailService implements PersonalizationtrailService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPersonalizationtrailService.class);
	...
	{
		return DefaultPersonalizationtrailService.class.getResourceAsStream("/personalizationtrail/sap-hybris-platform.png");
	}
