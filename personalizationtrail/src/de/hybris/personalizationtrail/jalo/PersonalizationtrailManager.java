...
/**
 * This is the extension manager of the Personalizationtrail extension.
 */
public class PersonalizationtrailManager extends GeneratedPersonalizationtrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PersonalizationtrailManager.class);
	 ...
	 */
	public static PersonalizationtrailManager getInstance()
	{
		return (PersonalizationtrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PersonalizationtrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PersonalizationtrailManager() // NOPMD 
	{
		LOG.debug("constructor of PersonalizationtrailManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PersonalizationtrailManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PersonalizationtrailManager called, current tenant: {}", getTenant().getTenantID());
	}
