 ...
 */
public class TestingbackofficeManager extends GeneratedTestingbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TestingbackofficeManager.class.getName());
	 ...
	 */
	public static TestingbackofficeManager getInstance()
	{
		return (TestingbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestingbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestingbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TestingbackofficeManager called.");
		}
	}
