 ...
 */
package de.hybris.platform.testingservice.jalo;
...
/**
 * This is the extension manager of the Testingservice extension.
 */
public class TestingserviceManager extends GeneratedTestingserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TestingserviceManager.class);
	 ...
	 */
	public static TestingserviceManager getInstance()
	{
		return (TestingserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestingserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestingserviceManager() // NOPMD 
	{
		LOG.debug("constructor of TestingserviceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TestingserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TestingserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
