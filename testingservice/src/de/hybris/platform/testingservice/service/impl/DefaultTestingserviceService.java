...
public class DefaultTestingserviceService implements TestingserviceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestingserviceService.class);
	...
	{
		return DefaultTestingserviceService.class.getResourceAsStream("/testingservice/sap-hybris-platform.png");
	}
