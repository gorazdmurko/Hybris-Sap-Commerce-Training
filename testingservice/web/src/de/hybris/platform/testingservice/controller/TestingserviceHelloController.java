 ...
 */
package de.hybris.platform.testingservice.controller;
...
@Controller
public class TestingserviceHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", testingserviceService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
