...
/**
 * This is the extension manager of the Checkboxconfiguratortemplateservices extension.
 */
public class CheckboxconfiguratortemplateservicesManager extends GeneratedCheckboxconfiguratortemplateservicesManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CheckboxconfiguratortemplateservicesManager.class);
	 ...
	 */
	public static CheckboxconfiguratortemplateservicesManager getInstance()
	{
		return (CheckboxconfiguratortemplateservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CheckboxconfiguratortemplateservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CheckboxconfiguratortemplateservicesManager() // NOPMD 
	{
		LOG.debug("constructor of CheckboxconfiguratortemplateservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CheckboxconfiguratortemplateservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CheckboxconfiguratortemplateservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
