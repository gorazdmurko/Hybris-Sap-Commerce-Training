...
/*
    *********************************************************************************************
    *                                                                                           *
    *   Create the CustomerReviewRaoExtractor.                                                  *
    *       This class overrides the following methods:                                         *
    *           - expandFact() - adds the generated CustomerReviewRAOs as facts                 *
    *           - getTriggeringOptions() - sets trigger option to EXPAND_CUSTOMER_REVIEWS       *
    *             that enables CustomerReviewRAOs fact expansion                                *
    *           - isDefault() - adds EXPAND_CUSTOMER_REVIEWS list of fact expansion options     *
    *                                                                                           *
    *********************************************************************************************
* */
