 ...
 ************************************************************************
 *                                                                      *
 *       IMPLEMENT THE PromotionenginetrailUserRaoPopulator             *
 *       populates customer reviews for the user. This populator        *
 *       uses your new customerReviewConverter to convert a             *
 *       CustomerReviewModel into a CustomerReviewRAO                   *
 *                                                                      *
 ************************************************************************
 * */
...
public class PromotionenginetrailUserRaoPopulator implements Populator<UserModel, UserRAO> {
    ...
    {
        target.setCustomerReviews(new ArrayList<CustomerReviewRAO>(Converters.convertAll(source.getCustomerReviews(),
