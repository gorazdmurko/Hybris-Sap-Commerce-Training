...
/*
    *************************************************************************************************************
    *   Implement a new AbstractRuleActionStrategy and name it DefaultAddUserToUserGroupActionStrategy.         *
    *   Implement the following methods:                                                                        *
    *       - apply() - responsible for executing our ChangeUserGroupRAO action. In this scenario,              *
    *           adding a user automatically adds it to the user group. It takes care of creating                *
    *           both the PromotionResultModel and the related RuleBasedAddUserToUserGroupActionModel.           *
    *                                                                                                           *
    *       - undo() - responsible for undoing what apply() has done. In this scenario, it means                *
    *           removing the user from the user group. The following displays the                               *
    *           DefaultAddUserToUserGroupActionStrategy class                                                   *
    *                                                                                                           *
    *************************************************************************************************************
* */
