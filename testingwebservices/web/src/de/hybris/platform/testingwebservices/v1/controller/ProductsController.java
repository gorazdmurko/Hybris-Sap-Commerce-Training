 ...
 */
package de.hybris.platform.testingwebservices.v1.controller;
...
import de.hybris.platform.testingwebservices.constants.YcommercewebservicesConstants;
import de.hybris.platform.testingwebservices.formatters.WsDateFormatter;
import de.hybris.platform.testingwebservices.product.data.ProductDataList;
import de.hybris.platform.testingwebservices.product.data.SuggestionDataList;
import de.hybris.platform.testingwebservices.queues.data.ProductExpressUpdateElementData;
import de.hybris.platform.testingwebservices.queues.data.ProductExpressUpdateElementDataList;
import de.hybris.platform.testingwebservices.queues.impl.ProductExpressUpdateQueue;
import de.hybris.platform.testingwebservices.stock.CommerceStockFacade;
import de.hybris.platform.testingwebservices.util.ws.SearchQueryCodec;
import de.hybris.platform.testingwebservices.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link de.hybris.platform.testingwebservices.populator.HttpRequestReviewDataPopulator} to populate review data
