 ...
 */
package de.hybris.platform.testingwebservices.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.testingwebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "testingwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "testingwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "testingwebservices.oauth2.tokenUrl";

	private static final String DESC = "testingwebservices.v1.description";
	private static final String TITLE = "testingwebservices.v1.title";
	private static final String VERSION = "testingwebservices.v1.version";
