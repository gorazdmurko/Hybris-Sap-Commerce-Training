...
import de.hybris.platform.testingwebservices.cart.impl.CommerceWebServicesCartFacade;
import de.hybris.platform.testingwebservices.exceptions.InvalidPaymentInfoException;
import de.hybris.platform.testingwebservices.exceptions.NoCheckoutCartException;
import de.hybris.platform.testingwebservices.exceptions.UnsupportedDeliveryModeException;
import de.hybris.platform.testingwebservices.exceptions.UnsupportedRequestException;
import de.hybris.platform.testingwebservices.order.data.CartDataList;
import de.hybris.platform.testingwebservices.order.data.OrderEntryDataList;
import de.hybris.platform.testingwebservices.product.data.PromotionResultDataList;
import de.hybris.platform.testingwebservices.request.support.impl.PaymentProviderRequestSupportedStrategy;
import de.hybris.platform.testingwebservices.stock.CommerceStockFacade;
import de.hybris.platform.testingwebservices.voucher.data.VoucherDataList;
