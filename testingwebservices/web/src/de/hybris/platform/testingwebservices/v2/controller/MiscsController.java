...
import de.hybris.platform.testingwebservices.order.data.CardTypeDataList;
import de.hybris.platform.testingwebservices.storesession.data.CurrencyDataList;
import de.hybris.platform.testingwebservices.storesession.data.LanguageDataList;
import de.hybris.platform.testingwebservices.user.data.CountryDataList;
import de.hybris.platform.testingwebservices.user.data.TitleDataList;
...
public class MiscsController extends BaseController
{
	...
	@ResponseBody
	@ApiOperation(value = "Get a list of shipping countries.", notes = "Lists all supported delivery countries for the current store. The list is sorted alphabetically.")
	@ApiBaseSiteIdParam
