...
public class DefaultTestingfacadeService implements TestingfacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestingfacadeService.class);
	...
	{
		return DefaultTestingfacadeService.class.getResourceAsStream("/testingfacade/sap-hybris-platform.png");
	}
