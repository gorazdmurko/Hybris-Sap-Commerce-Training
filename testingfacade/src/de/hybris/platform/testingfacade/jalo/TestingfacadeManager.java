 ...
 */
package de.hybris.platform.testingfacade.jalo;
...
/**
 * This is the extension manager of the Testingfacade extension.
 */
public class TestingfacadeManager extends GeneratedTestingfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TestingfacadeManager.class);
	 ...
	 */
	public static TestingfacadeManager getInstance()
	{
		return (TestingfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestingfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestingfacadeManager() // NOPMD 
	{
		LOG.debug("constructor of TestingfacadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TestingfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TestingfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
