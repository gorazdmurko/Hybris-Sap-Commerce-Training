...
/**
 * This is the extension manager of the CustomExtension extension.
 */
public class CustomExtensionManager extends GeneratedCustomExtensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CustomExtensionManager.class);
	 ...
	 */
	public static CustomExtensionManager getInstance()
	{
		return (CustomExtensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustomExtensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomExtensionManager() // NOPMD 
	{
		LOG.debug("constructor of CustomExtensionManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CustomExtensionManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CustomExtensionManager called, current tenant: {}", getTenant().getTenantID());
	}
