 ...
 */
package de.hybris.platform.checkboxconfiguratortemplatebackoffice.jalo;
...
import de.hybris.platform.checkboxconfiguratortemplatebackoffice.constants.CheckboxconfiguratortemplatebackofficeConstants;
 ...
 */
public class CheckboxconfiguratortemplatebackofficeManager extends GeneratedCheckboxconfiguratortemplatebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CheckboxconfiguratortemplatebackofficeManager.class.getName());
	 ...
	 */
	public static CheckboxconfiguratortemplatebackofficeManager getInstance()
	{
		return (CheckboxconfiguratortemplatebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CheckboxconfiguratortemplatebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CheckboxconfiguratortemplatebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CheckboxconfiguratortemplatebackofficeManager called.");
		}
	}
