...
/**
 * This is the extension manager of the Checkboxconfiguratortemplateaddon extension.
 */
public class CheckboxconfiguratortemplateaddonManager extends GeneratedCheckboxconfiguratortemplateaddonManager
{
	 ...
	 */
	public static CheckboxconfiguratortemplateaddonManager getInstance()
	{
		return (CheckboxconfiguratortemplateaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CheckboxconfiguratortemplateaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CheckboxconfiguratortemplateaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CheckboxconfiguratortemplateaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CheckboxconfiguratortemplateaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CheckboxconfiguratortemplateaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
