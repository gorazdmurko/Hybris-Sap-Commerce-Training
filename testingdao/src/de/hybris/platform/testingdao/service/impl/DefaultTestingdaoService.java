...
public class DefaultTestingdaoService implements TestingdaoService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestingdaoService.class);
	...
	{
		return DefaultTestingdaoService.class.getResourceAsStream("/testingdao/sap-hybris-platform.png");
	}
