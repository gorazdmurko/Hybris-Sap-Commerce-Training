...
/**
 * This is the extension manager of the Testingdao extension.
 */
public class TestingdaoManager extends GeneratedTestingdaoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TestingdaoManager.class);
	 ...
	 */
	public static TestingdaoManager getInstance()
	{
		return (TestingdaoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestingdaoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestingdaoManager() // NOPMD 
	{
		LOG.debug("constructor of TestingdaoManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TestingdaoManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TestingdaoManager called, current tenant: {}", getTenant().getTenantID());
	}
