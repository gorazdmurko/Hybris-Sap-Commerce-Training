package de.hybris.platform.checkboxconfiguratortemplateaddon.controllers.pages;
...
import de.hybris.platform.checkboxconfiguratortemplateaddon.forms.CheckboxConfigurationForm;
 ...
 *   Create a controller                                *
 *                                                      *
 *      for configurator-specific pages, one for both   *
 *      pages. Add the controller implementation        *
 *                                                      *
 ********************************************************
...
public class ProductCheckboxConfiguratorController extends AbstractPageController {
    ...
    // /p/${product.code}/configure/CHECKBOX
    ...
    // /cart/${entryNumber}/configuration/CHECKBOX"
