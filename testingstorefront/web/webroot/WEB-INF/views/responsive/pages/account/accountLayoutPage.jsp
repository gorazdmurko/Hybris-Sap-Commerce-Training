...
<template:page pageTitle="${pageTitle}">
    <div style="margin-left: 2vw">
        <h2>LAYOUT DATA</h2>
        <br />
        <h4>User's Profile Form</h4>
        <ul>
            <li><spring:theme code="Title: ${updateProfileForm.titleCode}" /></li>
            <li><spring:theme code="First name: ${updateProfileForm.firstName}" /></li>
            <li><spring:theme code="Last name: ${updateProfileForm.lastName}" /></li>
        </ul>
    </div>
