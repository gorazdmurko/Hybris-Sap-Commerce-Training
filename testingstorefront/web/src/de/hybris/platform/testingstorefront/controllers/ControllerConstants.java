 ...
 */
package de.hybris.platform.testingstorefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String TrainingVideoCmsComponent = _Prefix + TrainingVideoComponentModel._TYPECODE + _Suffix; // NOSONAR		/view/TrainingVideoComponentController
			String CustomParagraphCMSComponent = _Prefix + CustomParagraphComponentModel._TYPECODE + _Suffix;
		}
	}
	...
	interface Views
	{
		...
		interface Fragments
		{
			interface Cart // NOSONAR
			{
				...
				String CustomPopup = "fragments/cart/customPopup"; // NOSONAR
			}
