 ...
 */
package de.hybris.platform.testingstorefront.interceptors.beforeview;


import static de.hybris.platform.testframework.Assert.assertEquals;
import static de.hybris.platform.testingstorefront.interceptors.beforeview.ConsentManagementBeforeViewHandler.CONSENT_TEMPLATES;
...
import de.hybris.platform.jackson.BlackListingJackson1ObjectMapper;
...
public class ConsentManagementBeforeViewHandlerTest
{
	...
	private static final ObjectMapper mapper = BlackListingJackson1ObjectMapper.createObjectMapper();
	...
	{
		final ObjectMapper mapper = BlackListingJackson1ObjectMapper.createObjectMapper();
		return new Cookie[]
