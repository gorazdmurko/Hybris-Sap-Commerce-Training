...
/**
 * This is the extension manager of the Testingcore extension.
 */
public class TestingcoreManager extends GeneratedTestingcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TestingcoreManager.class);
	 ...
	 */
	public static TestingcoreManager getInstance()
	{
		return (TestingcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TestingcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestingcoreManager() // NOPMD 
	{
		LOG.debug("constructor of TestingcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TestingcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TestingcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
