...
public class DefaultTestingcoreService implements TestingcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTestingcoreService.class);
	...
	{
		return DefaultTestingcoreService.class.getResourceAsStream("/testingcore/sap-hybris-platform.png");
	}
