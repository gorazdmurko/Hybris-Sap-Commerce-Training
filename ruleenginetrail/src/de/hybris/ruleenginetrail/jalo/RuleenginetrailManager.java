...
/**
 * This is the extension manager of the Ruleenginetrail extension.
 */
public class RuleenginetrailManager extends GeneratedRuleenginetrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(RuleenginetrailManager.class);
	 ...
	 */
	public static RuleenginetrailManager getInstance()
	{
		return (RuleenginetrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RuleenginetrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RuleenginetrailManager() // NOPMD 
	{
		LOG.debug("constructor of RuleenginetrailManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RuleenginetrailManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RuleenginetrailManager called, current tenant: {}", getTenant().getTenantID());
	}
