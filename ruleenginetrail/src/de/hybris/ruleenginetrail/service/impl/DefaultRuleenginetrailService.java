...
public class DefaultRuleenginetrailService implements RuleenginetrailService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRuleenginetrailService.class);
	...
	{
		return DefaultRuleenginetrailService.class.getResourceAsStream("/ruleenginetrail/sap-hybris-platform.png");
	}
