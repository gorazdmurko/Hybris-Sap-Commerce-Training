...
/**
 * This is the extension manager of the Checkboxconfiguratortemplatefacades extension.
 */
public class CheckboxconfiguratortemplatefacadesManager extends GeneratedCheckboxconfiguratortemplatefacadesManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CheckboxconfiguratortemplatefacadesManager.class);
	 ...
	 */
	public static CheckboxconfiguratortemplatefacadesManager getInstance()
	{
		return (CheckboxconfiguratortemplatefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CheckboxconfiguratortemplatefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CheckboxconfiguratortemplatefacadesManager() // NOPMD 
	{
		LOG.debug("constructor of CheckboxconfiguratortemplatefacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CheckboxconfiguratortemplatefacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CheckboxconfiguratortemplatefacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
